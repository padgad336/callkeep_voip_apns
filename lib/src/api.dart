...
typedef Voip2dMessageHandler = Future<void> Function(String message);
...
class FlutterCallkeep extends EventManager {
  ...
  VoipMessageHandler? _voipMessageHandler;

  static void onVoipMessage(Voip2dMessageHandler? handler) {
  // FlutterCallkeep.onVoipMessage=handler;
  }
  ...
  Future<void> eventListener(MethodCall call) async {
    ...
    switch (call.method) {
      ...
      case 'CallKeepPushKitToken':
        ...
        break;
      case 'CallKeepDidReceiveVoipMessage':
      print("voip12");
      //   final handler = _voipMessageHandler;
      // onVoipMessage(handler);
        emit(CallKeepDidReceiveVoipMessage());
        break;
    }
  }
}

...
static NSString *const CallKeepDidReceiveVoipMessage = @"CallKeepDidReceiveVoipMessage";
...
- (void)sendEventWithNameWrapper:(NSString *)name body:(id)body {
    NSLog(@"[CallKeep][setup] options = %@ %@", name,body);
...
[self sendEventWithNameWrapper:CallKeepDidReceiveVoipMessage body:dic];
